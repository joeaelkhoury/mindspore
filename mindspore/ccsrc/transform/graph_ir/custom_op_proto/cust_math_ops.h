...
REG_OP(SilentCheck)
  .INPUT(val, TensorType({DT_FLOAT, DT_FLOAT16, DT_BFLOAT16}))
  .INPUT(input_grad, TensorType::BasicType)
  ...
  .OUTPUT(input_grad, TensorType::BasicType)
  ...
  .REQUIRED_ATTR(c_thresh_l1, Float)
  .REQUIRED_ATTR(c_coeff_l1, Float)
  .REQUIRED_ATTR(c_thresh_l2, Float)
  .REQUIRED_ATTR(c_coeff_l2, Float)
