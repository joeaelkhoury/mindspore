...
Strategies AntiQuantExpandStrategy(const StrategyPtr &strategy) {
  ...
  Dimensions in0_strategy = stra.at(0);
  Dimensions in1_strategy = stra.at(1);
  Dimensions in2_strategy = stra.at(2);
...
Status AntiQuantInfo::InferTensorMap() {
  ...
  Dimensions in0_expand_strategy = expand_strategy.at(0);
  Dimensions in1_expand_strategy = expand_strategy.at(1);
  Dimensions in2_expand_strategy = expand_strategy.at(2);
